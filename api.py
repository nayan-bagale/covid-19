...
def worlwide():
    ...
    data = response.json()
    try:
        total_cases = data['world_total']['total_cases']
        total_deaths = data['world_total']['total_deaths']
        total_recovered = data['world_total']['total_recovered']
        new_cases = data['world_total']['new_cases']
        new_deaths = data['world_total']['new_deaths']
        data_manage.total_world(total_cases,total_deaths,total_recovered,new_cases,new_deaths)
...
def main():
    ...
    print('Data is Updated ' +str(date))
